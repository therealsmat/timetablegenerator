...
class TimeTableGenerator {
     ...
     * @param array $gene
     */
    public function __construct(array $gene, $level)
    {
        $this->gene = $gene;
        $this->level = $level;
        $this->setLevelChapelPeriods();
    ...
    public function chapelPeriods()
    {
        return $this->chapelTime;
    }
        ...
        for ($x = 0; $x < $size; $x++) {
            ...
            for ($y = 0; $y < $this->daysOfWeek; $y++) {
                for ($z = 0; $z < $this->sizeOfDay; $z++) {
                    ...
                    {
                        continue;
                    }else if($this->isBreakTimeZone($seed))
                    {

                        continue;
                    }else if (in_array($seed, $this->chapelPeriods())) {
                        continue;
                    }
